          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-2 col-6">
              <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                <button type="button" className={`at-header-search-btn at-search-click ${isWhite ? "text-white" : "text-dark"}`} onClick={onOpenSearch}>
                ...
                <button type="button" className={`at-menu-bar at-header-sidebar-btn ${isWhite ? "text-white" : "text-dark"}`} onClick={onToggleSidebar}>
