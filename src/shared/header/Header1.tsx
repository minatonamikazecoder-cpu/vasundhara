        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-xl-8 mx-auto d-none d-xl-flex justify-content-center">
              <div className={`at-main-menu ${isWhite ? "menu-light" : "menu-dark"} d-inline-flex justify-content-center`}>
            ...
            <div className="col-xl-2 col-6">
              <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                <button type="button" className={`at-header-search-btn at-search-click ${isWhite ? "text-white" : "text-dark"}`} aria-label="Search" onClick={onOpenSearch}>
                ...
                <div className={`dark-light-mode ${isWhite ? "text-white" : "text-dark"}`}>
                  <ThemeSwitcher />
                </div>
                <button type="button" className={`at-menu-bar at-header-sidebar-btn ${isWhite ? "text-white" : "text-dark"}`} aria-label="Toggle Sidebar Menu" onClick={onToggleSidebar}>
