            ...
            <div className="col-xl-2 col-6">
              <div className="at-header-logo">
                <Link to="/" className="d-inline-flex align-items-center gap-2 text-decoration-none">
                  <img height={48} src="/assets/imgs/template/logo/favicon.png" alt="Vasundhara Financial Services" style={{ height: "48px", width: "auto", objectFit: "contain" }} />
                  <h6 className="fw-700 fz-28 text-white mb-0">Vasundhara</h6>
                </Link>
              </div>
            </div>
